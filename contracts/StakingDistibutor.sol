...
contract Distributor is Policy {
    ...
    constructor( address _treasury, address _quas, uint _epochLength, uint _nextEpochTime ) {        
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return IERC20( QUAS ).totalSupply().mul( _rate ).div( 1000000 );
    }
