...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, treasuryDeployment, quasDeployment, stakingDeployment, authorityDeployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, deploy(constants_1.CONTRACTS.distributor, {
                        from: deployer,
                        args: [
...
func.tags = [constants_1.CONTRACTS.distributor, "staking"];
func.dependencies = [
    constants_1.CONTRACTS.treasury,
    constants_1.CONTRACTS.QUAS,
    constants_1.CONTRACTS.bondingCalculator,
    constants_1.CONTRACTS.olympusAuthority,
];
