...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, quasDeployment, authorityDeployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, deploy(constants_1.CONTRACTS.treasury, {
                        from: deployer,
                        args: [quasDeployment.address, constants_1.TREASURY_TIMELOCK, authorityDeployment.address],
                        log: true,
...
func.tags = [constants_1.CONTRACTS.treasury, "treasury"];
func.dependencies = [constants_1.CONTRACTS.ohm, constants_1.CONTRACTS.authority];
