...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, quasDeployment, treasuryDeployment, authorityDeployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, deploy(constants_1.CONTRACTS.bondDepo, {
                        from: deployer,
                        args: [
...
func.tags = [constants_1.CONTRACTS.distributor, "bonding"];
func.dependencies = [
