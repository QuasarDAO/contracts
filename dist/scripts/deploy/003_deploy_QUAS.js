...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, authorityDeployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, deploy(constants_1.CONTRACTS.QUAS, {
                        from: deployer,
...
func.tags = [constants_1.CONTRACTS.QUAS, "staking", "tokens"];
func.dependencies = [constants_1.CONTRACTS.authority];
