...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, sQuasDeployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, deploy(constants_1.CONTRACTS.gQUAS, {
                        from: deployer,
...
func.tags = [constants_1.CONTRACTS.gQUAS, "migration", "tokens"];
func.dependencies = [constants_1.CONTRACTS.sQUAS];
