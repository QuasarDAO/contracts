...
npx hardhat run ./scripts/add_depository_as_reserve_depositor.ts --network localhost
npx hardhat run ./scripts/add_ido_depository_as_reserve_depositor.ts --network localhost
